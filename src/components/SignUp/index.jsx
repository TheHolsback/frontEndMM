...
import SitemarkIcon from '../styles/SitemarkIcon';
...
export default function SignUp(props) {
  ...
  const handleSubmit = (event) => {
    ...
    Axios.post(process.env.REACT_APP_API_S+"/register",{
      ...
      if (response.data.message === "Cadastrado com sucesso") {
        ...
        setDialogMessage("Você já está cadastrado! Por favor, entre na sua conta.");
      }
      setOpenDialog(true);
    })
    .catch((error) => {
  ...
  return (
    <AppTheme {...props}>
      ...
      <DialogTitle>{dialogMessage.includes("Cadastro") ? "Cadastro realizado com sucesso!" : "Você já está cadastrado!"}</DialogTitle>
      <DialogContent>
        {dialogMessage}
      </DialogContent>
      <DialogActions>
